...
(function () {
  ...
  function rotaAtual() {
    ...
    const validas = ["dashboard", "clientes", "chamados", "orcamentos", "pipeline", "catalogo", "ordens", "compras", "despesas", "financeiro", "agenda", "recorrencia", "relatorios", "configuracoes"];
