...
(function () {
  ...
  function rotaAtual() {
    ...
    const validas = ["dashboard", "clientes", "chamados", "orcamentos", "pipeline", "ordens", "compras", "despesas", "financeiro", "agenda", "recorrencia", "configuracoes"];
