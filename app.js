(function () {
  ...
  function setTitulo(titulo, subtitulo) {
    const t = $("#tituloTela"), s = $("#subtituloTela");
  ...
  function rotaAtual() {
    ...
    const validas = [
      "dashboard", "clientes", "chamados", "orcamentos", "pipeline", "catalogo", "ordens",
      "compras", "despesas", "financeiro", "agenda", "recorrencia", "relatorios", "configuracoes"
    ];
      ...
      <div class="layout">
        <aside class="sidebar">
          ...
          <nav class="nav">
            ...
            <a href="#pipeline" data-route="pipeline">Pipeline Comercial</a>
            <a href="#catalogo" data-route="catalogo">Produtos e Serviços</a>
  ...
  async function renderizarTelaAtual() {
    ...
    if (rota === "chamados") {
      ...
      if (
        ...
        typeof window.ModuloChamados.listarChamados === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
    ...
    if (rota === "orcamentos") {
      ...
      if (
        ...
        typeof window.ModuloBudgets.listarTelaOrcamentos === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
        return window.ModuloBudgets.listarTelaOrcamentos({
          areaId: "conteudoTela",
          sb: window.sb,
          companyId: window.sb.companyId,
          setErro,
    ...
    if (rota === "pipeline") {
      ...
      if (
        window.ModuloPipeline &&
        typeof window.ModuloPipeline.listarPipeline === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
        return window.ModuloPipeline.listarPipeline({
          areaId: "conteudoTela",
          sb: window.sb,
          companyId: window.sb.companyId,
          setErro,
    ...
    if (rota === "catalogo") {
      ...
      if (
        ...
        typeof window.ModuloCatalogo.listarCatalogo === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
        return window.ModuloCatalogo.listarCatalogo({
          areaId: "conteudoTela",
          sb: window.sb,
          companyId: window.sb.companyId,
          setErro,
    ...
    if (rota === "ordens") {
      ...
      if (
        window.ModuloOrdens &&
        typeof window.ModuloOrdens.listarOrdens === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
    ...
    if (rota === "compras") {
      ...
      if (
        ...
        typeof window.ModuloCompras.listarCompras === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
    ...
    if (rota === "despesas") {
      ...
      if (
        window.ModuloDespesas &&
        typeof window.ModuloDespesas.listarDespesas === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
    ...
    if (rota === "financeiro") {
      ...
      if (
        window.ModuloFinanceiro &&
        typeof window.ModuloFinanceiro.listarFinanceiro === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
    ...
    if (rota === "agenda") {
      ...
      if (window.ModuloAgenda && typeof window.ModuloAgenda.renderizarAgenda === "function") {
        return window.ModuloAgenda.renderizarAgenda({
          areaId: "conteudoTela",
          sb: window.sb,
          setErro,
          setInfo,
    ...
    if (rota === "relatorios") {
      ...
      if (
        ...
        typeof window.ModuloRelatorios.carregarRelatorios === "function" &&
        window.sb &&
        window.sb.db &&
        window.sb.companyId
      ) {
        return window.ModuloRelatorios.carregarRelatorios({
          areaId: "conteudoTela",
          sb: window.sb,
          companyId: window.sb.companyId,
          setErro,
      ...
      return placeholder("Relatórios", "Módulo de relatórios não carregado.");
    }
